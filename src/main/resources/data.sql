...
CREATE TABLE IF NOT EXISTS RENTING_CARS.TYPES (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    price NUMERIC(5,2) NOT NULL,
    extra NUMERIC(2,2) NOT NULL
);
CREATE TABLE IF NOT EXISTS RENTING_CARS.BRANDS (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL
);

CREATE TABLE IF NOT EXISTS RENTING_CARS.MODELS (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    yearModel DATE NOT NUll
);
CREATE TABLE IF NOT EXISTS RENTING_CARS.CARS (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS RENTING_CARS.CUSTOMERS (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    points LONG
);
CREATE TABLE IF NOT EXISTS RENTING_CARS.RENTALS (
    id BIGINT auto_increment PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    price NUMERIC(5,2) NOT NULL,
